...
$GLOBALS[$GLOBALS['idx_lang']] = array(
	...
	'info_commande_statut_envoye' => "Payée et envoyée",
	...
	// M
	'mentions_confidentialite' => "En cliquant sur « @label_bouton@ », vous confirmez que vous acceptez les <a href='@url@' class='c-lien'>Conditions générales d'utilisation et notre politique de confidentialité</a> qui vous informe des modalités de traitement de vos données personnelles ainsi que de vos droits sur ces données. <br>Vos coordonnées et informations personnelles ne font l'objet d'aucune commercialisation.",
	
	'mentions_cadeaux_profil' => "Vos coordonnées et informations personnelles ne font l'objet d'aucune commercialisation. Elles nous permettront de vous faire parvenir par courrier les exemplaires de votre abonnement.",
	
	'mentions_compte_profil' => "Vos coordonnées et informations personnelles ne font l'objet d'aucune commercialisation.",
