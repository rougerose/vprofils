...
// Fonctions reprise de Wordpress. 
// 
// Attention : la fonction getlocale() est adaptée pour utiliser la langue du site
// selon SPIP.
// 
 ...
 */
function vprofils_remove_accents( $string ) {
	...
	if ( wp_seems_utf8( $string ) ) {
		...
		if (isset($GLOBALS['meta']['langue_site'])) {
			$locale = $GLOBALS['meta']['langue_site'].'_'.strtoupper($GLOBALS['meta']['langue_site']);
		} else {
			$locale = 'fr_FR';
		}
